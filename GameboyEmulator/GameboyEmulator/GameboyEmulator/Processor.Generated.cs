...
namespace CrystalBoy.Emulation
{
	partial class Processor
	{
        ...
        internal bool Emulate(bool finishFrame)
        {
            ...
            //sb.AppendLine(string.Format(CultureInfo.InvariantCulture, "Frame : #{0}", frameCount));
            ...
            try
            {
                do
                {
                    ...
                    string before = string.Format(CultureInfo.InvariantCulture, registersString, a, f, b, c, d, e, h, l, pc, sp);
                    ...
                    string after = string.Format(CultureInfo.InvariantCulture, registersString, a, f, b, c, d, e, h, l, pc, sp);
                    ...
                    sb.AppendLine(string.Format(CultureInfo.InvariantCulture, "TotalCycleCount : {0}", totalCycleCount)); 
                ...
                if (frameCount == 5)
                {
                    using (var fs = new FileStream("D:\\log2.txt", FileMode.Create, FileAccess.Write))
                    {
